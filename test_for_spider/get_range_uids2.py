...
#     blognames_xpath = '//tr/td[@class="link335bbd"][2]/a/text()'
    bloghrefs_xpath = '//tr/td[@class="link335bbd"]/a/@href'
...
if __name__=="__main__":
    originalUrl = 'http://blog.sina.com.cn/lm/iframe/top100/{}.html'
    uids = []
    top_url = ['105','book','sport','finance','tech','eladies','edu','baby',
              'jiankang','eat','tour','pet','astro','comic','jczs','bbs',
              'house','jiaju','auto','golf','games','gongyi']
    for i in top_url:
